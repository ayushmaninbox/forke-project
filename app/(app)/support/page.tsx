...
import { submitSupportEnquiry } from './actions'
import { Headphones, Send, CheckCircle2, AlertTriangle, ShieldCheck } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col h-full bg-[#060608] text-white font-sans">
      ...
      <div className="flex-grow p-6 md:p-8 overflow-y-auto space-y-8 select-none max-w-3xl mx-auto w-full flex flex-col justify-center">
        {success ? (
          <div className="p-12 rounded-[2.5rem] bg-[#0b0b0e] border border-white/[0.04] text-center space-y-6 shadow-2xl animate-in fade-in duration-500 max-w-md mx-auto">
          ...
          <div className="p-8 rounded-[2.5rem] bg-[#0b0b0e] border border-white/[0.04] text-left shadow-2xl relative overflow-hidden space-y-8">

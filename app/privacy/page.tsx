...
const TOC_ITEMS = [
  { id: 'intro', label: 'Introduction & Consent' },
  { id: 'collection', label: 'Information We Collect' },
  { id: 'processors', label: 'Third-Party Sub-Processors' },
  { id: 'security', label: 'Storage, Security & Location' },
  { id: 'retention', label: 'Data Retention' },
  { id: 'tracking', label: 'Cookies & Tracking' },
      ...
      <div className="max-w-6xl mx-auto px-6 xl:grid xl:grid-cols-[1fr_240px] xl:gap-16 items-start pb-24">
        ...
        <div className="max-w-3xl w-full">
          ...
          <main className="space-y-12">
            ...
            <section id="processors" className="scroll-mt-28 space-y-4">
              <h2 className="text-lg font-semibold tracking-[-0.01em] text-white flex items-baseline gap-3">

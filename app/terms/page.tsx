...
const TOC_ITEMS = [
  ...
  { id: 'role', label: 'What Forke Is & Platform Role' },
  { id: 'eligibility', label: 'Eligibility & Minors' },
  { id: 'accounts', label: 'User Accounts & Security' },
  { id: 'payments', label: 'Bounties, Tasks & Payments' },
  { id: 'ai-policy', label: 'Task Completion & AI Code Usage' },
  { id: 'ip-ownership', label: 'Intellectual Property & Code Ownership' },
  { id: 'confidentiality', label: 'Confidentiality' },
  { id: 'arbitration', label: 'Dispute Resolution & Platform Arbitration' },
  { id: 'gamification', label: 'XP, Reputation & Gamification' },
      ...
      <div className="max-w-6xl mx-auto px-6 xl:grid xl:grid-cols-[1fr_240px] xl:gap-16 items-start pb-24">
        ...
        <div className="max-w-3xl w-full">
          ...
          <main className="space-y-12">
            ...
            {/* 02. What Forke Is */}
            <section id="role" className="scroll-mt-28 space-y-4">
              <h2 className="text-lg font-semibold tracking-[-0.01em] text-white flex items-baseline gap-3">
            ...
            <section id="payments" className="scroll-mt-28 space-y-6">
              <h2 className="text-lg font-semibold tracking-[-0.01em] text-white flex items-baseline gap-3">
            ...
            <section id="ai-policy" className="scroll-mt-28 space-y-4">
              <h2 className="text-lg font-semibold tracking-[-0.01em] text-white flex items-baseline gap-3">
            ...
            <section id="gamification" className="scroll-mt-28 space-y-4">
              <h2 className="text-lg font-semibold tracking-[-0.01em] text-white flex items-baseline gap-3">
            ...
            <section id="law" className="scroll-mt-28 space-y-4">
              <h2 className="text-lg font-semibold tracking-[-0.01em] text-white flex items-baseline gap-3">

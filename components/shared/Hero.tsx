      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 top-[44%] sm:top-[42%] w-[130%] max-[420px]:w-[120%] sm:w-[min(85%,56dvh)] md:w-[min(72%,60dvh)] aspect-square lg:top-1/2 lg:left-auto lg:translate-x-0 lg:-translate-y-1/2 lg:absolute lg:w-[1200px] lg:h-[1200px] lg:aspect-auto lg:right-[-300px] pointer-events-none z-0">
            ...
            {/* Floating Rupees */}
            <div
              className="gsap-hero-badge absolute top-[45%] left-[25%] w-7 h-7 sm:w-10 sm:h-10 lg:w-14 lg:h-14 rounded-full bg-accent/20 border border-accent/40 flex items-center justify-center text-accent text-xs sm:text-base lg:text-xl font-bold z-0 rotate-[-5deg] opacity-0"
              data-speed="0.07"
            >
              ₹
            </div>
            <div
              className="gsap-hero-badge absolute top-[58%] right-[25%] w-6 h-6 sm:w-9 sm:h-9 lg:w-12 lg:h-12 rounded-full bg-accent/20 border border-accent/40 flex items-center justify-center text-accent text-[10px] sm:text-sm lg:text-lg font-bold z-0 rotate-[9deg] opacity-0"
              data-speed="0.06"
            >
              ₹
            </div>
            ...
            {/* Floating Task Cards */}
            <div
              className="gsap-hero-badge absolute top-[28%] left-[26%] glass p-1.5 sm:p-2.5 lg:p-3 rounded-lg lg:rounded-xl shadow-glow z-0 pointer-events-auto transition-transform opacity-0"
              data-speed="0.04"
            >
            ...
            <div
              className="gsap-hero-badge absolute top-[42%] right-[19.5%] glass p-1.5 sm:p-2.5 lg:p-3 rounded-lg lg:rounded-xl shadow-glow z-20 pointer-events-none transition-transform opacity-0"
              data-speed="0.05"
            >
              <div className="flex items-center justify-between gap-2 sm:gap-4 lg:gap-6 mb-0.5 lg:mb-1">
            ...
            <div
              className="gsap-hero-badge absolute top-[24%] right-[42%] glass-orange px-2 py-1 sm:px-3 sm:py-1.5 lg:px-4 lg:py-2 rounded-full flex items-center gap-1.5 sm:gap-2 lg:gap-3 shadow-[0_0_30px_rgba(255,122,0,0.2)] z-20 border border-white/20 pointer-events-none hover:scale-105 transition-transform opacity-0"
              data-speed="0.03"
            >
            ...
            <div
              className="gsap-hero-badge absolute top-[27%] right-[30%] glass px-1.5 py-1 sm:px-2.5 sm:py-1.5 lg:px-3 lg:py-2 rounded-full border border-white/10 flex items-center gap-1 sm:gap-1.5 lg:gap-2 shadow-2xl z-10 pointer-events-none rotate-[7deg] opacity-0"
              data-speed="0.02"
            >

      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isActive
                      ...
                      : "bg-white/[0.02] border-[var(--color-border)] text-[var(--color-text-muted)] hover:border-white/20 hover:text-white"
                  )}
                >
                  {tag}
                </button>
        ...
        <div className="flex items-end gap-2.5 shrink-0">
          ...
          {hasFilters && (
            <button
              onClick={clearFilters}
              className="hidden lg:flex items-center gap-1.5 h-9 px-3 rounded-lg text-[13px] font-medium ui-btn-secondary cursor-pointer"
            >
              <X className="w-3.5 h-3.5" />
              Clear
            </button>
